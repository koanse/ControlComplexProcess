...
namespace Process
{
    ...
    {
        public static List<Mark> lM = new List<Mark>();
        public static string[][] arrGroup;
        public static string[] arrGName;
        public static void Initialize()
        {
            lM.Add(new Mark("Ст.0", new List<ElC>(new ElC[] {
                new ElC("S", 0, 0.06), new ElC("C", 0, 0.23), new ElC("P", 0, 0.07) })));
            lM.Add(new Mark("08кп", new List<ElC>(new ElC[] {
                new ElC("Si", 0, 0.03), new ElC("Mn", 0.25, 0.50), new ElC("Cu", 0, 0.25),
                new ElC("As", 0, 0.08), new ElC("Ni", 0, 0.25), new ElC("S", 0, 0.04),
                new ElC("C", 0.05, 0.11), new ElC("P", 0, 0.035), new ElC("Cr", 0, 0.10)})));
            lM.Add(new Mark("10", new List<ElC>(new ElC[] {
                new ElC("Si", 0.17, 0.37), new ElC("Mn", 0.35, 0.65), new ElC("Cu", 0, 0.25),
                new ElC("As", 0, 0.08), new ElC("Ni", 0, 0.25), new ElC("S", 0, 0.04),
                new ElC("C", 0.07, 0.14), new ElC("P", 0, 0.035), new ElC("Cr", 0, 0.15)})));
            lM.Add(new Mark("20", new List<ElC>(new ElC[] {
                new ElC("Si", 0.17, 0.37), new ElC("Mn", 0.35, 0.65), new ElC("Cu", 0, 0.25),
                new ElC("As", 0, 0.08), new ElC("Ni", 0, 0.25), new ElC("S", 0, 0.04),
                new ElC("C", 0.17, 0.24), new ElC("P", 0, 0.035), new ElC("Cr", 0, 0.25)})));
            lM.Add(new Mark("09Г2", new List<ElC>(new ElC[] {
                new ElC("N", 0, 0.008),
                new ElC("Si", 0.17, 0.37), new ElC("Mn", 1.4, 1.8), new ElC("Cu", 0, 0.30),
                new ElC("As", 0, 0.08), new ElC("Ni", 0, 0.30), new ElC("S", 0, 0.04),
                new ElC("C", 0, 0.12), new ElC("P", 0, 0.035), new ElC("Cr", 0, 0.30)})));
            lM.Add(new Mark("40", new List<ElC>(new ElC[] {
                new ElC("Si", 0.17, 0.37), new ElC("Mn", 0.50, 0.80), new ElC("Cu", 0, 0.25),
                new ElC("As", 0, 0.08), new ElC("Ni", 0, 0.25), new ElC("S", 0, 0.04),
                new ElC("C", 0.37, 0.45), new ElC("P", 0, 0.035), new ElC("Cr", 0, 0.25)})));
            lM.Add(new Mark("45", new List<ElC>(new ElC[] {
                new ElC("Si", 0.17, 0.37), new ElC("Mn", 0.50, 0.80), new ElC("Cu", 0, 0.25),
                new ElC("As", 0, 0.08), new ElC("Ni", 0, 0.25), new ElC("S", 0, 0.04),
                new ElC("C", 0.42, 0.50), new ElC("P", 0, 0.035), new ElC("Cr", 0, 0.25)})));
            lM.Add(new Mark("У10", new List<ElC>(new ElC[] {
                new ElC("Si", 0.17, 0.33), new ElC("Mn", 0.17, 0.33), new ElC("Cu", 0, 0.25),
                new ElC("Ni", 0, 0.25), new ElC("S", 0, 0.028),
                new ElC("C", 0.96, 1.03), new ElC("P", 0, 0.030), new ElC("Cr", 0, 0.20)})));
            lM.Add(new Mark("У12", new List<ElC>(new ElC[] {
                new ElC("Si", 0.17, 0.33), new ElC("Mn", 0.17, 0.33), new ElC("Cu", 0, 0.25),
                new ElC("Ni", 0, 0.25), new ElC("S", 0, 0.028),
                new ElC("C", 1.16, 1.23), new ElC("P", 0, 0.030), new ElC("Cr", 0, 0.20)})));
            lM.Add(new Mark("25ХГСА", new List<ElC>(new ElC[] {
                new ElC("Si", 0.90, 1.20), new ElC("Mn", 0.80, 1.10), new ElC("Cu", 0, 0.30),
                new ElC("Ni", 0, 0.30), new ElC("S", 0, 0.025),
                new ElC("C", 0.22, 0.28), new ElC("P", 0, 0.025), new ElC("Cr", 0.80, 1.10)})));
            lM.Add(new Mark("30ХГСА", new List<ElC>(new ElC[] {
                new ElC("Si", 0.90, 1.20), new ElC("Mn", 0.80, 1.10), new ElC("Cu", 0, 0.30),
                new ElC("Ni", 0, 0.30), new ElC("S", 0, 0.025),
                new ElC("C", 0.28, 0.34), new ElC("P", 0, 0.025), new ElC("Cr", 0.80, 1.10)})));
            lM.Add(new Mark("Р9", new List<ElC>(new ElC[] {
                new ElC("V", 2.30, 2.70), new ElC("W", 8.50, 9.50), new ElC("Co", 0, 0.50),
                new ElC("Si", 0, 0.50), new ElC("Mn", 0, 0.50), new ElC("Mo", 0, 1.0),
                new ElC("Ni", 0, 0.40), new ElC("S", 0, 0.03),
                new ElC("C", 0.85, 0.95), new ElC("P", 0, 0.03), new ElC("Cr", 3.80, 4.40)})));
            lM.Add(new Mark("50ХФА", new List<ElC>(new ElC[] {
                new ElC("V", 0.10, 0.20),
                new ElC("Si", 0.17, 0.37), new ElC("Mn", 0.50, 0.80), new ElC("Cu", 0, 0.20),
                new ElC("Ni", 0, 0.25), new ElC("S", 0, 0.025),
                new ElC("C", 0.46, 0.54), new ElC("P", 0, 0.025), new ElC("Cr", 0.80, 1.10)})));
            arrGroup = new string[][]
            {
                new string[] { "Ст.0", "08кп", "10", "20", "09Г2" },
                new string[] { "40", "45", "У10", "У12" },
                new string[] { "25ХГСА", "30ХГСА" },
                new string[] { "Р9" },
                new string[] { "50ХФА" }
            };
            arrGName = new string[] {
                ...
                "Легированные стали и сплавы: 25ХГСА, 30ЧГСА, Э31, ЭИ962, ЭИ496",
                "Легированные стали и сплавы: ЭП213, ЭИ846, ЭПП55, Р9",
                "Легированные стали и сплавы: ЭИ100, Э22, ЭИ712, ЭИ811, 50ХФА, 12Х5МА"
            };
        }
        public static string SetGroup(string[] arrEl, double[] arrC,
            out double aT, out double bT, out double aP, out double bP, out double aH, out double bH, out string report)
        {
            double[] arrW = new double[lM.Count];
            double max = double.MinValue;
            int iMax = 0;
            report = "Идентификация марки<br><table border = 1><tr><td>Марка<td>Состав<td>Оценка";
            for (int i = 0; i < lM.Count; i++)
            {
                arrW[i] = lM[i].Compare(arrEl, arrC);
                if (arrW[i] > max)
                {
                    max = arrW[i];
                    iMax = i;
                }
                report += string.Format("<tr><td>{0}<td>{1}<td>{2:g4}", lM[i].name, lM[i], arrW[i]);
            }
            report += "</table>";
            int j = 0;
            for (j = 0; j < arrGroup.Length; j++)
                if (arrGroup[j].Contains(lM[iMax].name))
                    break;
            switch (j)
            {
                case 0:
            ...
            report += string.Format("Результат<br>Марка: {0}<br>Группа: {1}<br>", lM[iMax], arrGName[j]);
            report += string.Format("ПТ = ПТ<sub>исх</sub> + {0}e<sup>{1}</sup><br>" +
                "ПП = {2}ПТ + {3}<br>HB = {4}ПТ + {5}",
                aT, bT, aP, bP, aH, bH);            
            return lM[iMax].ToString();
        }
        public static double Calculate(string[] arrEl, double[] arrC, double sTOld, double e, string x, string y, double xValue,
            out string report)
        {
            if (arrEl.Contains(x))
            {
            ...
            string rep;
            SetGroup(arrEl, arrC, out aT, out bT, out aP, out bP, out aH, out bH, out rep);
            double sT = sTOld + aT * Math.Pow(e, bT);
            switch (y)
            {
                case "ПТ":
                    report = string.Format("ПТ = {2:g4}", aT, bT, sT);
                    return sT;
                case "ПП":
                    double sP = aP * sT + bP;
                    report = string.Format("ПП = {2:g4}", aP, bP, sP);
                    return sP;
                case "HB":
                    double HB = aH * sT + bH;
                    report = string.Format("HB = {2:g4}", aH, bH, HB);
                    return HB;
                default:
                    throw new Exception();
            }
    ...
    public class Mark : IComparable
    {
        ...
        public Mark(string name, List<ElC> lEl)
        {
            this.name = name;
            this.lEl = lEl;
            lEl.Sort();
        }
        public double Compare(string[] arrEl, double[] arrC)
        {
            double sum = 0;
            int n = 0;
            ...
            for (int i = 0; i < arrEl.Length; i++)
            {
                int index = lEl.BinarySearch(new ElC(arrEl[i]));
                if (index < 0)
                    continue;
                n++;
                lI.Add(index);
                if (lEl[index].min <= arrC[i] && arrC[i] <= lEl[index].max)
                    sum += 1;
                else
                    sum += (1 - Math.Min(Math.Abs(arrC[i] - lEl[index].min),
                        Math.Abs(arrC[i] - lEl[index].max)) / 100);
            }
        ...
        {
            string res = "";
            foreach (ElC ep in lEl)
                res += ep.ToString() + ";";
            return res.Substring(0, res.Length - 1);
        }
        public int CompareTo(object obj)
        {
            return name.CompareTo(((Mark)obj).name);
        }
    }
    public struct ElC : IComparable
    {
        public string element;
        public double min, max;
        public ElC(string element)
        {
            this.element = element;
            min = 0;
            max = 1;
        }
        public ElC(string element, double min, double max)
        {
            this.element = element;
            this.min = min;
            this.max = max;
        ...
        public int CompareTo(object obj)
        {
            return element.CompareTo(((ElC)obj).element);
        }
        public override string ToString()
        {
            if (min == 0 && max == 1)
                ...
                return string.Format("{0} = [{1:g3}; {2:g3}]", element, min, max);
        }
    }
